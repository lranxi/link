...
public class TimeBasedUUIDGenerator {
    ...
    private final AtomicInteger sequenceNumber = new AtomicInteger(SECURE_RANDOM_INSTANCE.nextInt());
    ...
    public static void main(String[] args) {
        TimeBasedUUIDGenerator generator = new TimeBasedUUIDGenerator();
        for (int i = 0; i < 100000; i++) {
            String s = generator.getBase64UUID();
            if(s.length() != 20){
                System.out.println(generator.getBase64UUID());
            }
        }
    }
    ...
    public static class MacAddressProvider {
        ...
        public static byte[] getSecureMungedAddress() {
            ...
            SECURE_RANDOM_INSTANCE.nextBytes(mungedBytes);
            for (int i = 0; i < 6; ++i) {
        ...
        private static byte[] constructDummyMulticastAddress() {
            ...
            SECURE_RANDOM_INSTANCE.nextBytes(dummy);
            /*
